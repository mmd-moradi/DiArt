                  ...
                  >
                    ...
                    <div className="flex items-center justify-between px-2 pb-3 border-b border-white border-opacity-10">
                      ...
                      <div className="flex items-center space-x-1">
                        <FaDollarSign />
                        <p className="text-white text-center text-lg font-semibold leading-tight tracking-tighter">
                          {art.price}
                        </p>
                      </div>
                    </div>
                    <div className="flex items-center justify-between px-2 pb-4">
                      ...
                      <button
                        onClick={() => router.push(`/arts/${art.uuid}`)}
                        className="text-[12px] font-medium text-primary text-center rounded-md px-[20px] py-1 border border-gray-300 bg-white cursor-pointer hover:bg-secondary"
                      >
                        View
                      </button>
                    </div>
