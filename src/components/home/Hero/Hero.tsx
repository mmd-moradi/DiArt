    ...
    <section className="px-8 md:px-16">
      <div className="flex flex-col gap-16 py-4 w-full md:flex-row md:gap-0">
        <div className="w-full flex flex-col items-start gap-[38px] md:pt-8 md:flex-1">
          <Heading className="tracking-tight leading-snug">
            Discover, collect,
            <br />
            and sell extraordinary DiArts
          </Heading>
          <p className="text-secondary text-lg md:text-xl font-medium tracking-wider">
            Welcome to our website , where we provide comprehensive information
            on DiArts (Digital Arts) and their impact on the digital world .
          </p>
          <div className="flex items-center mt-6 gap-8">
            ...
            <button
              ...
              className="bg-transparent outline-none text-center rounded-lg px-10 py-[15px] font-semibold text-white text-lg border border-secondary cursor-pointer hover:bg-whiteAlpha1 md:px-14"
            >
              Create
            </button>
          </div>
        ...
        <div className="flex flex-col items-end md:flex-1">
          <div className="w-full rounded-3xl border border-blue-500 bg-gradient-primary-2 flex flex-col gap-4 px-8 py-6 md:max-w-[500px]">
            ...
            <div className="mt-2 flex flex-col gap-4">
              ...
              <div className="flex items-center justify-between">
                <p className="text-secondary text-base font-medium tracking-wide">
                  MRD #10123334
                </p>
