        ...
        <div className="flex flex-col items-start px-8 w-full md:px-16">
          ...
          <div className="flex flex-col items-start gap-4 w-full pb-8">
            <div className="flex flex-col items-start justify-center">
              <span className="text-2xl font-semibold leading-5 md:text-3xl">
                {userData?.userName}
              </span>
            </div>
            <div className="flex justify-start items-center gap-4">
              <span className="text-sm font-normal leading-5 md:text-base">
                {userData?.email}
              </span>
              <span className="text-sm font-normal leading-6 md:text-base">
                Joined {getJoinedMonthAndYear(userData?.createdAt!)}
              </span>
            </div>
          </div>
          <div className="flex flex-col items-start w-full border-t border-gray-800 py-8">
            <div className="flex justify-start">
              <span className="text-xl font-semibold leading-6">
                {userData?.createdArts?.length} created Arts
              </span>
            </div>
            {createdDArts ? (
          ...
          <div className="flex flex-col items-start w-full border-t border-gray-800 py-8">
            <div className="flex justify-start">
              <span className="text-xl font-semibold leading-6">
                {userData?.purchasedArts?.length} purchased Arts
              </span>
            </div>
            {purchasedDArts && (
